...
::
    ...
    print('Initial state for parameters')
...
.. autoclass:: optigatrust.Chip
   :members: current_limit, sleep_activation_delay, uid, global_lifecycle_state, security_status, security_event_counter
