...
@pytest.mark.parametrize("hash_alg, hazmat_curve, curve", [
    ('sha256', ec.SECP256R1(), 'secp256r1',),
    ('sha384', ec.SECP384R1(), 'secp384r1',),
    ('sha512', ec.SECP521R1(), 'secp521r1',),
    ('sha256', ec.BrainpoolP256R1(), 'brainpoolp256r1',),
    ('sha384', ec.BrainpoolP384R1(), 'brainpoolp384r1',),
    ('sha512', ec.BrainpoolP512R1(), 'brainpoolp512r1',)
])
